...
Fungsi utama:
  ...
  run_market_close_deep_analysis(symbol, bot, mt5_conn) -> dict
      ...
      Hasil disimpan ke data/session/session_plan.json untuk dipakai Senin open.
...
State disimpan di: data/session/session_bias_state.json
"""
...
from app.core.paths import SESSION_BIAS_STATE_PATH as _STATE_PATH, SESSION_DIR as _SESSION_DIR, SESSION_PLAN_PATH as _PLAN_PATH
