...
News Cache:
  data/cache/{symbol}_{tanggal}.json — cache harian 24 jam
...
class NewsFilter:
    ...
    def train_news_model(self, price_df) -> dict:
        ...
        """
        try:
            from app.services.ai.news_model import NewsDirectionModel
    ...
    def _print_news_train_result(self, result: dict) -> None:
        ...
        if not result.get("trained"):
            ...
            from app.services.ai.news_model import MODEL_MIN_SAMPLES
