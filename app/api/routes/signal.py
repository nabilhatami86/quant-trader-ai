...
from app.database.crud.signals import build_signal_payload, get_recent_signals, insert_signal
from app.api.schemas.signal import SignalHistoryOut, SignalOut
...
async def get_current_signal(bot: BotService = Depends(get_bot)):
    ...
    return {
        ...
        # ScalpML
        "scalp_pred"   : bot.get_scalp_signal(),
    }
